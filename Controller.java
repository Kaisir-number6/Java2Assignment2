...
public class Controller implements Initializable {
    ...
    public static int win()
    {
        ...
        for (int y=0;y<3;y++)
        {
            ...
            if (chessBoard[0][y]==chessBoard[1][y]&&chessBoard[1][y]==chessBoard[2][y]&&chessBoard[1][y]!=0)
            {return chessBoard[1][y];}
        }
        ...
        if(chessBoard[2][0]==chessBoard[1][1]&&chessBoard[2][0]==chessBoard[0][2]&&chessBoard[1][1]!=0)
        {
